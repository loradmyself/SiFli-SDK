...
xmlInitCharEncodingHandlers(void) {
    ...
    if (xmlNewCharEncodingHandler("UTF-8", UTF8ToUTF8, UTF8ToUTF8) == NULL)
        goto failed;
#ifdef LIBXML_OUTPUT_ENABLED
    xmlUTF16LEHandler =
          xmlNewCharEncodingHandler("UTF-16LE", UTF16LEToUTF8, UTF8ToUTF16LE);
    if (xmlUTF16LEHandler == NULL) goto failed;
    xmlUTF16BEHandler =
          xmlNewCharEncodingHandler("UTF-16BE", UTF16BEToUTF8, UTF8ToUTF16BE);
    if (xmlUTF16BEHandler == NULL) goto failed;
    if (xmlNewCharEncodingHandler("UTF-16", UTF16LEToUTF8, UTF8ToUTF16) == NULL) goto failed;
    if (xmlNewCharEncodingHandler("ISO-8859-1", isolat1ToUTF8, UTF8Toisolat1) == NULL) goto failed;
    if (xmlNewCharEncodingHandler("ASCII", asciiToUTF8, UTF8Toascii) == NULL) goto failed;
    if (xmlNewCharEncodingHandler("US-ASCII", asciiToUTF8, UTF8Toascii) == NULL) goto failed;
#ifdef LIBXML_HTML_ENABLED
    if (xmlNewCharEncodingHandler("HTML", NULL, UTF8ToHtml) == NULL) goto failed;
#endif
#else
    xmlUTF16LEHandler =
    ...
    if (xmlUTF16BEHandler == NULL) goto failed;
    if (xmlNewCharEncodingHandler("UTF-16", UTF16LEToUTF8, NULL) == NULL) goto failed;
    if (xmlNewCharEncodingHandler("ISO-8859-1", isolat1ToUTF8, NULL) == NULL) goto failed;
    if (xmlNewCharEncodingHandler("ASCII", asciiToUTF8, NULL) == NULL) goto failed;
    if (xmlNewCharEncodingHandler("US-ASCII", asciiToUTF8, NULL) == NULL) goto failed;
#endif /* LIBXML_OUTPUT_ENABLED */
...
xmlCleanupCharEncodingHandlers(void) {
    ...
    xmlUTF16LEHandler = NULL;
    xmlUTF16BEHandler = NULL;
}
