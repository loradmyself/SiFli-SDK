...
#define _INLINE PCDATA FONTSTYLE PHRASE SPECIAL FORMCTRL
...
static const char* inline_p[] = { _INLINE, "p", NULL } ;
...
static const char* form_contents[] = { HEADING, LIST, _INLINE, "pre", "p", "div", "center", "noscript", "noframes", "blockquote", "isindex", "hr", "table", "fieldset", "address", NULL } ;
