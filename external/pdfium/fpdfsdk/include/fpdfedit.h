...
//			pageObject	-	Handle to a page object.
// Return value:
//			One of FPDF_PAGEOBJ_* constants. Returns 0 for invalid object.
DLLEXPORT int STDCALL FPDFPageObj_GetType(FPDF_PAGEOBJECT pageObject);

// Function: FPDFPageObj_GetBounds
//			Get page object bounds in page coordinates.
// Parameters:
//			pageObject	-	Handle to a page object.
//			left		-	Pointer to receive bounds left.
//			top		-	Pointer to receive bounds top.
//			right		-	Pointer to receive bounds right.
//			bottom		-	Pointer to receive bounds bottom.
// Return value:
//			TRUE if successful, FALSE otherwise.
